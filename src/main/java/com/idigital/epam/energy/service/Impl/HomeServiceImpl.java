...
public class HomeServiceImpl implements HomeService, CommonService<Home> {
    ...
    public Home createInstitutional() throws Exception {
        ...
        String aas =  hmACUtils.getRequestWithHmac("ENERGY", "get_homes", "http://citymanagementbackend-env-1.eba-3swwhqnr.us-east-2.elasticbeanstalk.com/api/v1/request/institutionalWithOwner", "energyKey").getBody().toString();
